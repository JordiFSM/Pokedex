...
import ModalPokemon from "./components/ModalPokemons";
...
function App() {
  ...
  return (
    <section className="bg-[#c6d4e1] h-screen font-outfit overflow-y-auto bg-[url(/pokeball-icon.png)] bg-no-repeat bg-[-10%_-20%] overflow-x-hidden">
